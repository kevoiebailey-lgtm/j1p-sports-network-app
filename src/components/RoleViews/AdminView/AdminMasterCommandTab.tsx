...
const AdminOverviewPage = lazyWithRetry(() => 
  import('../../Admin/AdminOverviewPage').then(m => ({ default: m.default || m.AdminOverviewPage }))
);
const AdminUsersPage = lazyWithRetry(() => 
  import('../../Admin/AdminUsersPage').then(m => ({ default: m.default || m.AdminUsersPage }))
);
const AdminMediaModularView = lazyWithRetry(() => 
  import('../../Admin/AdminMediaModularView').then(m => ({ default: m.default || m.AdminMediaModularView }))
);
const AdminEventsPage = lazyWithRetry(() => 
  import('../../Admin/AdminEventsPage').then(m => ({ default: m.default || m.AdminEventsPage }))
);
const AdminFinancialsPage = lazyWithRetry(() => 
  import('../../Admin/AdminFinancialsPage').then(m => ({ default: m.default || m.AdminFinancialsPage }))
);
const AdminSettingsPage = lazyWithRetry(() => 
  import('../../Admin/AdminSettingsPage').then(m => ({ default: m.default || m.AdminSettingsPage }))
);
