...
export type VideoPlatformType = 'youtube' | 'vimeo' | 'instagram' | 'tiktok' | 'hudl' | 'direct' | 'unsupported';
 ...
 */
export function parseUniversalVideoUrl(rawUrl: string): ParsedVideoResult {
  ...
  // 6. Direct Video Fallback (.mp4, .webm, .mov, blob, firebasestorage, etc.)
