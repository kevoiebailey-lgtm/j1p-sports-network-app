...
// Code Splitting with Auto-Retry: Admin View Tabs (4 Tabs)
const AdminMasterCommandTab = lazyWithRetry(() => import('./components/RoleViews/AdminView/AdminMasterCommandTab').then(m => ({ default: m.default || m.AdminMasterCommandTab })));
...
function MainAppShell() {
  ...
  useEffect(() => {
    ...
    if (canonical === 'athlete') {
      ...
      preloadModule(() => import('./components/RoleViews/AdminView/AdminMasterCommandTab'));
